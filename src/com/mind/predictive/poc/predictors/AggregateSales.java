...
import com.mind.predictive.poc.mr.SalesPredictorMapper;
import com.mind.predictive.poc.mr.util.MRConstants;
import com.mind.predictive.poc.mr.util.Util;
import com.mind.prescription.PredictiveAnalyticsSales;

public class AggregateSales extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		job.setMapperClass(SalesPredictorMapper.class);
	...
	public static void main(String[] args) throws Exception {
		MRConstants.PREDICTIVE_OUTPUT_FOLDER = MRConstants.PREDICTIVE_OUTPUT_FOLDER_PREFIX
				+ Util.dateFormat_yyyy_MM_dd_HH_mm_ss() + "_Sales";
		ToolRunner.run(new AggregateSales(), args);
		MRConstants.HBASE_ROW = MRConstants.PREDICTIVE_MODEL + "_Sales";
		...
		try {
			...
			PredictiveAnalyticsSales.main(null);
		} catch (Exception e) {

			logger.error("--- ERROR --- " + e.getMessage());
		}

		logger.info("-- Sales prediction completed...");
		return;
	}
}
