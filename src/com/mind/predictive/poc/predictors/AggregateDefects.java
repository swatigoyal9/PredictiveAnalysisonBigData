...
import com.mind.predictive.poc.mr.DefectsPredictorMapper;
import com.mind.predictive.poc.mr.util.MRConstants;
import com.mind.predictive.poc.mr.util.Util;
import com.mind.prescription.PredictiveAnalyticsDefects;

public class AggregateDefects extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		job.setMapperClass(DefectsPredictorMapper.class);
	...
	public static void main(String[] args) throws Exception {
		MRConstants.PREDICTIVE_OUTPUT_FOLDER = MRConstants.PREDICTIVE_OUTPUT_FOLDER_PREFIX
				+ Util.dateFormat_yyyy_MM_dd_HH_mm_ss() + "_Defects";
		ToolRunner.run(new AggregateDefects(), args);
		MRConstants.HBASE_ROW = MRConstants.PREDICTIVE_MODEL + "_Defects";
		...
		try {
			...
			PredictiveAnalyticsDefects.main(null);
		} catch (Exception e) {

			logger.error("--- ERROR --- " + e.getMessage());
		}

		logger.info("-- Defects prediction completed...");
		return;
	}
}
